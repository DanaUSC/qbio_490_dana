...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("/Users/danasouter/Desktop/qbio490/qbio_490_dana")) 
```
...
string_var <- "This is QBIO490 fall 2023 class"
char_var <- "C"
...
age <- 20
birthday <- "01/19/2004"
three_fav_colors <- "blue, green, pink"
...
```{r Exercise 9.4}
am_colname <- which(colnames(mtcars) == "am")
df_copy <- mtcars[ , -am_colname]
```
